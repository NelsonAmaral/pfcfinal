...
function buscarVacinacaoMes(rg_usuario) {
...
if(window.XMLHttpRequest) {
 ...
 var acao = "ConsultarVacinasObMesAtual";
// Arquivo PHP juntamente com o valor digitado no campo (método GET)
var url = "../ControlerCalendarioObr?acao="+acao+"&rg_usuario="+rg_usuario;
...
req.onreadystatechange = function() {
	...
	if(req.readyState == 1) {
		document.getElementById('returnConsulta').innerHTML = 'Buscando a Consulta...';
	}
	...
	document.getElementById('returnConsulta').innerHTML = resposta;
	}
}
req.send(null);
}
