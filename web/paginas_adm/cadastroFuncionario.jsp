                        ...
                        <form action="ControleFuncionario" method="POST"><br/>
                            ...
                            <div class="row">
                                ...
                                <div class='col s4'>
                                    ...
                                    <select class="browser-default" name="txtPerfil" required>
                            ...
                            <div class="row">
                                <div class="col s6">
                                     <label class="black-text left-align" for="txtTiposague">Postos<i class="material-icons left">assignment</i></label>
                                     <select class="browser-default" id="filtrar-estado" name="txtfkposto" required>
                                    ...
                                    %>
                                        ...
                                        <option value="<%= postos.getPosto_id() %>" selected><%= postos.getPosto_nome() %></option> 
